...
from xinnovation.src.core import HEADS
from xinnovation.src.components.lightning_module.detectors.base import BaseModule
from xinnovation.src.core.registry import BBOX_CODERS, BBOX_SAMPLERS, LOSSES, PLUGIN_LAYERS, POSITIONAL_ENCODING
from xinnovation.src.core.dataclass import TrajParamIndex, ObjectType
